                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        return GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => BookDetails(catDetailsMap: catMapList[index],)));
                          },
                          child: Container(
                            height: 230,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          catMapList[index]['LikedBy']+' Active Readers'.tr,
                                          style: TextStyle(
                                            fontSize: 12,
                                            color: Colors.grey[400],
                                          ),
